...
public class LNDBWrapper : DbConnectionBase
{
    ...
    public LNDBWrapper()
    {
        AssignDBInfo(string.Empty);
    }

    public LNDBWrapper(string ConnectionString)
    {
        AssignDBInfo(ConnectionString);
    }

    private void AssignDBInfo(string ConnectionString)
    {
        try
        {
            string[] dbInfoArr;
            ...
            {
                dbInfoArr = ConfigurationManager.AppSettings.Get("ConnectionString").Split(new char[] { ';' });
            }
            else
            {
                dbInfoArr = ConnectionString.Split(new char[] { ';' });
            }
