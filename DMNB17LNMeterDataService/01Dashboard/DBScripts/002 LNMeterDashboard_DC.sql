...
Insert into udtLNMeterGroup ([MeterGroupCategoryID], [GroupName],[GroupDesc], [Sort])
Values 
	(@MeterGroupCategoryID,  N'B17厂房总用空调能量计', N'B17厂房总用空调能量计',1),
	(@MeterGroupCategoryID,  N'B17 1F注塑', N'B17 1F注塑',1);
Go
Declare @MeterGroupCategoryID int
...
Update @udtLNMeterMap Set xMeterGroupID  = g.ID from udtLNMeterGroup g where xGroupName  = g.[GroupName]
Update @udtLNMeterMap Set xMeterID = e.ID from udtLNWaterMeter e where xMeterAddr = e.MeterAddr
select *  from @udtLNMeterMap
