    ...
    public class LNMeterMgr : LNDBWrapper
    {
        ...
        internal static LNMeterCategory GenMeterCategoryInstance(DataRow dr)
        {
            LNMeterCategory objTemp = new LNMeterCategory
            {
                ...
                Command = dr[3].ToString(),
                CycleTime = double.Parse(dr[4].ToString()),
                UDPToSaveData = dr[5].ToString(),
                UDPToSaveRuntimeLog = dr[6].ToString(),
                AssemblyName = dr[7].ToString(),
                ClassName = dr[8].ToString()
            };
            return objTemp;
        }
    }
