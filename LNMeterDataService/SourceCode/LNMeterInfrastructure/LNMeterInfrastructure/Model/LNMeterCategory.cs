        ...
        public LNMeterCategory(int id)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    this.Command = dt.Rows[0][3].ToString();
                    this.CycleTime = double.Parse(dt.Rows[0][4].ToString());
                    this.UDPToSaveData = dt.Rows[0][5].ToString();
                    this.UDPToSaveRuntimeLog = dt.Rows[0][6].ToString();
                    this.AssemblyName = dt.Rows[0][7].ToString();
                    this.ClassName = dt.Rows[0][8].ToString();
                }
                else
                {
