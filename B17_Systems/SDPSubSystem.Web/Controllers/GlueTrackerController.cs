...
{
    public class GlueTrackerController : BaseController
    {
        ...
        public ActionResult MainLoad(string code)
        {
            ...
            DataSet ds = _service.RunProcedure("uspGlueTracker", Sqlparam, "bb", ConDB.PlataContext);
        ...
        public ActionResult MainEdit(int ID)
        {
            ...
            DataSet ds = _service.RunProcedure("uspGlueTracker", Sqlparam, "bb", ConDB.PlataContext);
            GlueTrack_GlueMain am = new GlueTrack_GlueMain
            {
                ...
                ProjectName = ds.Tables[0].Rows[0][4],
        ...
        public ActionResult SaveEdit(string poststr)
        {
            ...
            try
            {
                ...
                string errormsg = _service.RunProcedure("uspGlueTracker", sqlxml, out code, ConDB.PlataContext);
        ...
        public ActionResult ColorLoad(string code)
        {
            ...
            DataSet ds = _service.RunProcedure("uspGlueTrack_DashboardColorDefinition", Sqlparam, "bb", ConDB.PlataContext);
        ...
        public ActionResult ColorSaveEdit(string poststr)
        {
            ...
            try
            {
                ...
                string sqlxml = XmlParams.CreateSqlXml(dic);
                //DataTable dt = _service.GetSelectItems(XmlParams.CreateSqlXml(dic), Request.Params["X_DB_MATRIX"]);
                string errormsg = _service.RunProcedure("uspGlueTrack_DashboardColorDefinition", sqlxml, out code, ConDB.PlataContext);
        ...
        public ActionResult MaintenanceLoad(string code)
        {
            ...
            DataSet ds = _service.RunProcedure("uspGlueTrack_ProductStructure", Sqlparam, "bb", ConDB.PlataContext);
        ...
        public ActionResult MaintenanceSaveEdit(string poststr)
        {
            ...
            try
            {
                ...
                string sqlxml = XmlParams.CreateSqlXml(dic);
                //DataTable dt = _service.GetSelectItems(XmlParams.CreateSqlXml(dic), Request.Params["X_DB_MATRIX"]);
                string errormsg = _service.RunProcedure("uspGlueTrack_ProductStructure", sqlxml, out code, ConDB.PlataContext);

                
                if (code == 0)
                {
                    //更新料号的时候，同步数据
                    SyncBaanData_Glue_Jabra();
        ...
        public ActionResult MaintenanceImport()
        {
            ...
            try
            {
                ...
                if (files != null && files.Count > 0)
                {
                    ...
                    int code = 0;
                    errormsg = _service.RunProcedure("uspGlueTrack_ProductStructureImport", sqlxml, out code, ConDB.PlataContext);
                    if (code == 0)
                    {
                        //导入的时候，同步数据
                        SyncBaanData_Glue_Jabra();
        ...
        public ActionResult GetDashboardData()
        {
            ...
            DataSet ds = _service.RunProcedure("udpGetGlueUsageData", Sqlparam, "bb", ConDB.PlataContext);
        ...
        public ActionResult GetHistoryData()
        {
            ...
            DataSet ds = _service.RunProcedure("uspGlueTrackerChangeHistoryDashboard", Sqlparam, "bb", ConDB.PlataContext);
