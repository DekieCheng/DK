...
(function() {
    ...
    JSLINQ.fn = JSLINQ.prototype = {
        ...
        //Replace: function (name,regexp, replacement) {
        //    var newarr = new Array();
        //    for (var a = 0; a < this.items.length; a++) {
        //        console.log(this.items[a][name]);
        //        var ele = this.items[a][name];
        //        if (ele.contains('\\')) {
        //            this.items[a][name] = this.items[a][name].replace('*\\', '');
        //        }
        //        newarr[a] = this.items[a];
        //    }
        //    return newarr;
        //},
