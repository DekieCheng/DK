;(function ($, window, document, undefined) {
    ...
    obj_import.prototype = {
        init:function(){
            ...
            e.click(function () {
                ...
                var message_lang = "Are you sure you want to import Customer \"" + Customer+"\" 's RMA data?";
                var title_lang = "Confirm";
                var import_lang = "Import";
                var cancel_lang = "Cancel";
                if ($('body').attr("LangID") != "1") {
                    message_lang = "是否确认导入客户\""+Customer+"\"的RMA数据?";
                    title_lang = " 确认";
                    import_lang = "导入";
                    cancel_lang = "取消";
                }
    ...
    $.fn.x_import_RMA = function (option) {
