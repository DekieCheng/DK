...
{
    public class ExcelToAll_waterfall
    {
        /// <summary>
        /// 把excel文件转换数据表
        /// </summary>
        ...
        public static String getDecimalString(String inputValue)
        {

            if (inputValue.ToUpper().IndexOf("E") > 0)
            {

                decimal value = (decimal)(float.Parse(inputValue));
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        if (j > 3)
                                        {
                                            cellValue = getDecimalString(System.Security.SecurityElement.Escape(row.GetCell(j).ToString()));
                                        }
                                        else
                                        {
                                            cellValue = System.Security.SecurityElement.Escape(row.GetCell(j).ToString());
