...
namespace SDPSubSystem.Data
{
    public class MsSql
    {
        ...
        static MsSql()
        {
            ...
            {
                //_connectionString = Encry.Encry.Decryptosdp(System.Configuration.ConfigurationManager.ConnectionStrings["DbContext"].ConnectionString);
                _connectionString = DESSecurity.Decrypt(System.Configuration.ConfigurationManager.ConnectionStrings["DbContext"].ConnectionString);
            }
        }
