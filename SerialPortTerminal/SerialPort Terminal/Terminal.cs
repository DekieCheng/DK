...
namespace SerialPortTerminal
{
    ...
    public partial class frmTerminal : Form
    {
        ...
        private void EnableControls()
        {
            ...
            btnAutoSend.Enabled = comport.IsOpen;
        ...
        private void btnAutoSend_Click(object sender, EventArgs e)
        {
            try
            {
                if (!this.tmrAutoSend.Enabled)
                {
                    this.btnAutoSend.Text = "Stop";
                    this.tmrAutoSend.Enabled = true;
                    this.tmrAutoSend.Interval = int.Parse(this.nupInterval.Value.ToString());
                    this.tmrAutoSend.Start();
                }
                else
                {
                    this.tmrAutoSend.Enabled = false;
                    this.btnAutoSend.Text = "Start";
